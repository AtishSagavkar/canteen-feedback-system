...
<div class="food-card"><img class="food-img" src="${food.img}"><div>${food.name}</div><div class="star-rating"><input type="radio" name="food${i}" value="5" id="f${i}5"><label for="f${i}5"><i class="fa fa-star"></i></label>
